...
text = """
 kamla yaar 420. zefoy   """
"""\033[1;93m  ᴬᴹᴱᴱᴿ ᴹᵁᴴᴬᴹᴹᴬᴰ ᴴᵁˢˢᴬᴵᴺ420
...
class zefoy:
    ...
    def main(self):
        ...
        self.change_title("TikTok Automator using zefoy.com | Github: @Ameerhussain302")
    ...
    def check_status(self):
        ...
        for thing in self.xpaths:
            ...
            if not element.is_enabled():
                statuses.update({thing: f"{}[OFFLINE]"})
